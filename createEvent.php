...
<div class="row" style="padding-top: 5%">
    <div class="col s6 offset-s3">
        <form name="create" method="post" action="processEvent.php">
            <div class="card">
                <div class="row">
                    <div class="card-title center" style="padding-top: .3em">
                        ...
                        <div class="row">
                            <div class="input-field col s6">
                                <input name="title" id="input_text" type="text" maxlength="30" data-length="30">
                                <label for="input_text">Event Name</label>
                            </div>
                        </div>
                    </div>
                    <div class="card-action">
                        <div class="input-field col s12" style="padding-bottom: 1em;">
                        <textarea name="event" id="textarea1" class="materialize-textarea" maxlength="20" data-length="20"
                                  style="padding-bottom: 10px;"></textarea>
                            <label for="textarea1">Event Info</label>
                        </div>
                    </div>
                </div>
            </div>
